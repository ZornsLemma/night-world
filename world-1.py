...
label(0x529a, "sprite_core_moving_low_byte_wrap_handled")
label(0x529e, "sprite_core_moving_low_byte_wrap2_handled")
expr(0x52a2, "sprite_ptr")
expr(0x52a6, "sprite_ptr")
expr(0x52aa, "sprite_ptr+1")
expr(0x52ad, "sprite_ptr2")
expr(0x52b1, "sprite_ptr2")
expr(0x52b5, "sprite_ptr2+1")
label(0x52d9, "sprite_core_moving_low_byte_wrapped")
label(0x52de, "sprite_core_moving_low_byte_wrapped2")
expr(0x520a, "sprite_ptr")
expr(0x5212, "sprite_ptr")
expr(0x521a, "sprite_ptr")
expr(0x5228, "sprite_ptr")
expr(0x522f, "sprite_ptr")
expr(0x5233, "sprite_ptr")
expr(0x5237, "sprite_ptr+1")
