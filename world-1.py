...
for i in range(28):
    ...
    comment(0x55c0+i*2, "index %d" % i, inline=True)
...
label(0x5378, "sprite_y_pixel_coord_lt_2_indirect")
...
constant(0x70, "t_subroutine_os_x_hi")
constant(0x71, "t_subroutine_os_x_lo")
constant(0x72, "t_subroutine_os_y_hi")
#constant(0x73, "t_subroutine_os_y_lo")
expr(0x5362, "t_subroutine_os_x_lo")
expr(0x5367, "t_subroutine_os_x_hi")
expr(0x530c, "t_subroutine_os_x_hi")
expr(0x536c, "t_subroutine_os_y_hi")
expr(0x530e, "t_subroutine_os_y_hi")
constant(0x7f, "t_subroutine_w_minus_1_times_2")
expr(0x5316, "t_subroutine_w_minus_1_times_2")
expr(0x532f, "t_subroutine_w_minus_1_times_2")
constant(0x7e, "t_subroutine_w_minus_1_times_4")
expr(0x531a, "t_subroutine_w_minus_1_times_4")
expr(0x5328, "t_subroutine_w_minus_1_times_4")
constant(0x76, "t_subroutine_w_minus_1_times_8")
expr(0x531f, "t_subroutine_w_minus_1_times_8")
expr(0x5360, "t_subroutine_w_minus_1_times_8")
expr(0x533d, "t_subroutine_os_x_hi")
expr(0x5340, "t_subroutine_os_x_hi")
expr(0x5343, "t_subroutine_os_x_hi")
expr(0x5345, "t_subroutine_os_x_lo")
expr(0x535a, "t_subroutine_os_y_hi")
expr(0x535d, "t_subroutine_os_y_hi")
expr(0x537b, "t_subroutine_os_x_hi")
expr(0x5391, "t_subroutine_os_x_hi")
expr(0x5394, "t_subroutine_os_x_hi")
expr(0x5397, "t_subroutine_os_x_hi")
expr(0x5399, "t_subroutine_os_x_lo")
expr(0x53a9, "t_subroutine_os_x_hi")
expr(0x53bb, "t_subroutine_os_y_hi")
expr(0x53c7, "t_subroutine_os_y_hi")
...
label(0x53ac, "add_negative_x_offset")
comment(0x537a, "TODO: This is called once, via a bcc.")
label(0x537a, "new_x_pixel_coord_lt_0")
comment(0x537c, "always branch", inline=True)
label(0x539c, "t_subroutine_x_pixel_coord_is_fe")
label(0x53b4, "update_y_pixel_coord_indirect")
label(0x53ca, "sprite_y_pixel_coord_lt_2")
label(0x5346, "update_y_pixel_coord")
label(0x538c, "new_x_pixel_coord_in_a")
label(0x53a8, "new_x_coord_carry")
