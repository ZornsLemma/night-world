...
REM TODO NEED TO ENCODE THE THREE DIFFERENT TEMPOS OVER THE PART WE'RE INTERESTED IN (ADAGIO/PRESTISSIMO/LENTO)
REM Bar 1
...
REM Bar 10
DATA "f", 2, "a", 2, "d", 2, "f", 2, "a", 2, "d", 2, "e", 2, "g", 2, "c#", 2, "e", 2, "g", 2, "c#", 2, "", 8, "-c", 2, "e", 2, "g", 2, "b_", 2
