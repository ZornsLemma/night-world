...
; TODO: ROOM D IS CORRUPT WHEN FIRST DISPLAYED, I THINK BECAUSE THE BASIC DISPLAYS THE SOLID ENEMY *THEN* THE "NON-SOLID" STATUE IT OVERLAPS
; TODO: WHEN THE GAME STARTS, WE GET SOME CORRUPTION IN THE BANNER UNDER THE "H" OF "NIGHT"
