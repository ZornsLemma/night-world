...
; TODO: ROOM D IS CORRUPT WHEN FIRST DISPLAYED, I THINK BECAUSE THE BASIC DISPLAYS THE SOLID ENEMY *THEN* THE "NON-SOLID" STATUE IT OVERLAPS - I BELIEVE THIS IS THE ONLY ROOM WHERE AN ENEMY STARTS OUT OVERLAPPING OF ANOTHER SPRITE
; TODO: WARPING INTO ROOM N, LETTING THE EYE GET ON TOP OF YOU AND THEN MOVING AWAY TO RIGHT CAN LEAVE CORRUPTION BEHIND
