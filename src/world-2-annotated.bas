...
constant TWEAK_STROBE=&9FD
 ...
 1296SOUND1,6,60,4:PROCdelay(120):VDU19,1,colour1%;0;19,2,colour2%;0;19,3,colour3%;0;:ENDPROC
 ...
 1405IF A$="9":PROCset8(R_TABLE_SCORE,90):FORn%=1TO4:n%?(R%!R_TABLE_ITEM_COLLECTED)=1:NEXT:REM TODO: TEMPORARY CHEAT, SO NOT OPTIONAL
