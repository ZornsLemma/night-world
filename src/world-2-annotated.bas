   ...
   20VDU17,128,17,3,12,26,19,3,7;0;:B$=STRING$(3,CHR$8)+CHR$10:A$=CHR$232+CHR$233+CHR$234+B$+CHR$235+":"+CHR$236+B$+CHR$243+CHR$236+CHR$244+B$+CHR$235+CHR$234+CHR$236:PROCf:VDU5:GCOL0,3:MOVE532,528:PRINTA$:PROCdelay(18000):VDU4
   ...
   80*FX200,2
   90PROCtitle_screen:PROCr:PROCp:IFw%=1:PROCo
  100PROCg:GOTO70
  ...
  380GOTO280
  390DEFPROCjg:PROCso:VDU19,0,7;0;19,1,0;0;19,2,0;0;19,3,0;0;:SOUND&10,-13,5,6:SOUND0,-10,5,6:SOUND0,-7,6,10:PROCdelay(250):VDU19,0,0;0;19,1,c1%;0;19,2,c2%;0;19,3,c3%;0;:ENDPROC
 ...
 1190PROCso:PROCdelay(100):SOUND1,6,20,4:VDU19,0,7;0;:score%=score%+20:ec%=50:PROCdelay(150):VDU19,0,0;0;:IFlogical_room%=9:score%=score%-10:COLOUR1:PRINTTAB(ex%,5)CHR$246:ex%=16:VDU17,0,17,131:PRINTTAB(16,5)CHR$224:VDU17,128
 1200ENDPROC
 1210IFdf%>1:SOUND1,11,ec%,2:GOTO1230
 1220IFa%=2ANDday_night%=1ANDX%=5:ENDPROC ELSEPROCso:IFa%=2SOUND1,9,ec%,2 ELSEIFX%=7:SOUND1,8,ec%,4 ELSESOUND1,12,ec%,5
 ...
 1290DEFPROCsf:VDU19,1,7;0;19,2,7;0;19,3,7;0;:SOUND1,6,60,4:PROCdelay(120):VDU19,1,c1%;0;19,2,c2%;0;19,3,c3%;0;:ENDPROC
 ...
 1320DEFPROCtitle_screen:c1%=7:c2%=6:c3%=1:PROCreset_note_count
 ...
 1490VDU19,1,1;0;19,2,6;0;19,3,7;0;17,3:s$=STR$score%+"%":PROCf:PRINTTAB(5,16);:VDU232,233,234,235,32,32,238,239,235,240,5:GCOL0,2:FORn%=416TO412STEP-4:MOVE544,n%:PRINTs$:NEXT:VDU4:PROCdelay(14000):COLOUR1:PRINTTAB(ex%,5)CHR$246:ENDPROC
