...
constant DELTA_STEP_RIGHT_DOWN = 9
  ...
  660IFdb%=6ANDJ%>lee_y_os%:Z%=DELTA_STEP_RIGHT_DOWN ELSEIFdb%=6ANDJ%<lee_y_os%:Z%=DELTA_STEP_RIGHT_UP
  670IFdb%=4ANDJ%>lee_y_os%:Z%=DELTA_STEP_LEFT_DOWN ELSEIFdb%=4ANDJ%<lee_y_os%:Z%=DELTA_STEP_LEFT_UP
