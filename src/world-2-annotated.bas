...
constant FIXED_PALETTE3=7
  ...
  851IFb1%=13THENOSCLI"DISC":OSCLI"SAVE SCR 5800 8000":END
 ...
 1501IF?TWEAK_FIXED_PALETTE=0:VDU19,1,1;0;19,2,3;0;19,3,6;0;
 1502PROCclear_room:COLOUR2:PRINTTAB(6,16);:VDU232,233,234,235,32,235,242,245,5:GCOL0,1:a$=CHR$10+STRING$(12,CHR$8):FORn%=416TO412STEP-4:MOVE256,n%
