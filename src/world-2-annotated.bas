...
constant R_TABLE_SCORE = 78
  ...
  950IFFNget8(R_TABLE_ROOM_TYPE)=5:Y%=S_OP_REMOVE:CALLS%:I%=640:J%=316:Y%=S_OP_MOVE:CALLS%:ed%=6:IFFNget8(R_TABLE_SCORE)>70ANDFNget8(R_TABLE_SCORE)<100:X%=IMAGE_VEIL:CALLU% ELSEIFFNget8(R_TABLE_ROOM_TYPE)=5ANDFNget8(R_TABLE_SCORE)=100:X%=IMAGE_FINAL_GUARDIAN:CALLU%
