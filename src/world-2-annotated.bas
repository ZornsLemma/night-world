...
constant R_TABLE_AK = 54
  ...
  730DEFPROCroom_type4:Z%=ad%(FNget8(R_TABLE_AH)):PROCset8(R_TABLE_AK,FNget8(R_TABLE_AK)+1):IFFNget8(R_TABLE_AK)=40:PROCset8(R_TABLE_AK,0):PROCset8(R_TABLE_AH,FNget8(R_TABLE_AH)+1):IFFNget8(R_TABLE_AH)=5:PROCset8(R_TABLE_AH,1)
  740CALLT%:ENDPROC

  750DEFPROCroom_type3:Z%=ed%(FNget8(R_TABLE_AH)):PROCset8(R_TABLE_AK,FNget8(R_TABLE_AK)+1):IFFNget8(R_TABLE_AK)=30:PROCset8(R_TABLE_AK,0):PROCset8(R_TABLE_AH,FNget8(R_TABLE_AH)+1):IFFNget8(R_TABLE_AH)=7:PROCset8(R_TABLE_AH,1)
  760CALLT%:ENDPROC
