...
constant R_TABLE_CONTINUE_AFTER_ADVANCE_SUN_MOON = 76
  ...
  635Y%=S_OP_REMOVE:W%=SLOT_SUN_MOON:CALLS%:W%=SLOT_MISC:CALLS%:RESTORE1450:score%=100:PROCset8(R_TABLE_SUN_MOON_DISABLED,1):PROCremove_lee_sprite:FORn%=10TO100STEP5:FORnm%=110TO200STEPn%:READok%:VDU19,1,ok%;0;19,2,ok%;0;19,3,ok%;0;:IFok%=0:RESTORE1450
 ...
 1191IFFNget8(R_TABLE_LOGICAL_ROOM)=9:score%=score%-10:COLOUR1:PRINTTAB(FNget8(R_TABLE_ENERGY_MAJOR),5)CHR$246:PROCset8(R_TABLE_ENERGY_MAJOR,16):VDU17,0,17,131:PRINTTAB(16,5)CHR$224:VDU17,128
