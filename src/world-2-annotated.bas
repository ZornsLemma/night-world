...
constant R_TABLE_PENDING_SOUND_AND_LIGHT_SHOW_SECOND_PART = 84
  ...
  622IFnext_flash%=0:PROCdelay(RND(40)):VDU19,0,7;0;19,1,0;0;19,0,0;0;19,1,3;0;:next_flash%=RND(2) ELSE next_flash%=next_flash%-1
  628ENDPROC
 ...
 1405IF A$="9":PROCset8(R_TABLE_SCORE,90):REM TODO TEMP ALWAYS-ON CHEAT
