...
constant R_TABLE_PENDING_SOUND_AND_LIGHT_SHOW_SECOND_PART = 84
  ...
  254VDU19,0,0;0;19,1,colour1%;0;19,2,colour2%;0;19,3,colour3%;0;:CALLR%!R_TABLE_PLAY_280:GOTOM%
  ...
  390DEFPROCsound_and_light_show:PROCstop_sound:VDU19,0,7;0;19,1,0;0;19,2,0;0;19,3,0;0;:SOUND&10,-13,5,6:SOUND0,-10,5,6:SOUND0,-7,6,10:ENDPROC
  ...
  550NEXT:VDU19,1,colour1%;0;19,2,colour2%;0;19,3,colour3%;0;:PROCstop_sound:W%=SLOT_SUN_MOON:Y%=S_OP_REMOVE:CALLS%:K%=192
  ...
  640SOUND1,4,n%+nm%,2:SOUND2,12,n%+nm%,3:NEXT,:VDU19,3,4;0;19,2,0;0;19,1,6;0;17,131,17,2:colour1%=6:colour2%=0:colour3%=4:PRINTTAB(9,14)STRING$(4,CHR$227):COLOUR128:CALLV%:ENDPROC
 ...
 1351PROCset8(R_TABLE_ENERGY_MAJOR,16):PROCset8(R_TABLE_ENERGY_MINOR,10):PROCset8(R_TABLE_LOGICAL_ROOM,8):PROCset8(R_TABLE_DAY_NIGHT,0):w%=0:D%=576:C%=1120:K%=192:L%=108:PROCset8(R_TABLE_JUMPING,0):PROCset8(R_TABLE_DELTA_X,0):sd%=10:PROCset8(R_TABLE_LEE_DIRECTION,10):PROCset8(R_TABLE_FALLING_DELTA_X,0)
