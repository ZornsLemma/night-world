...
constant R_TABLE_ROOM_TYPE_1_CONTINUE = 58
  ...
  251M%=RND(3):P.TAB(0,0);M%;" ";:CALLR%!R_TABLE_ROOM_TYPE_1_CONTINUE:GOTOM%
  ...
  259ON JUNK GOTO 251,255,360,256,257,258:REM TODO TEMP - SO ABE PACK LEAVES THESE LINES ALONE
