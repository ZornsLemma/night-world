...
constant R_TABLE_PENDING_SOUND_AND_LIGHT_SHOW_SECOND_PART = 84
  ...
  256PROCpause:CALLR%!R_TABLE_PLAY_320:GOTOM%:REM TODO TEMP - MAYBE?could really feel fblr (esp first set) in stomach but not utterly terrible, ffr added an extra rep, not easy and definitely felt in stomach but not too bad, form probably reasonably good
 ...
 1401*FX13,5
 1402PROCset8(R_TABLE_SCORE,100):REM TODO HACK
